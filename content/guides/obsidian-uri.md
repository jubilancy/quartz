...
- `vault` can be either the vault name or the vault ID <sup><a href="https://help.obsidian.md/Extending+Obsidian/#fn-1-6ffa5eb8923de7e1">[1]</a></sup>.
...
- `vault` can be either the vault name, or the vault ID <sup><a href="https://help.obsidian.md/Extending+Obsidian/#fn-1-6ffa5eb8923de7e1">[1-1]</a></sup>. Same as action `open`.
...
- `vault` can be either the vault name, or the vault ID <sup><a href="https://help.obsidian.md/Extending+Obsidian/#fn-1-6ffa5eb8923de7e1">[1-2]</a></sup>. Same as action `open`.
...
- `vault` (optional) can be either the vault name, or the vault ID <sup><a href="https://help.obsidian.md/Extending+Obsidian/#fn-1-6ffa5eb8923de7e1">[1-3]</a></sup>. If not provided, the current or last focused vault will be used.
- `x-success` (optional) see [Use x-callback-url parameters](https://help.obsidian.md/Extending+Obsidian/Obsidian+URI#Use%20x-callback-url%20parameters).
